...
fprintf('--------------------TASK THREE--------------------------------------\n');
fprintf('------------------------------------------------------------------\n');
fprintf('1) The estimate obtained with the delayed inputs has a lower cross validation error due to the fact that we used twice the data to estimate the second estimate, producing less variance estimate.\n');
