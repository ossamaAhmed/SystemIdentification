...
%plotting the time response of the hann window for different gammas
g5 = 5;
g10 = 10;
g50 = 50;
g100 = 100;
[lagsg5, Wtg5] = WtHann(g5, N);
[lagsg10, Wtg10] = WtHann(g10, N);
[lagsg50, Wtg50] = WtHann(g50, N);
[lagsg100, Wtg100] = WtHann(g100, N);
...
[omega_Hann_time_domain, ETFE_Hann_Estimate_gamma_5] = ETFE_Smoothed_Hann(u, y, g100);
idx_Hann_time_domain = find(omega_Hann_time_domain > 0 & omega_Hann_time_domain < pi);
figure(7);
loglog(omega_Hann_time_domain(idx_Hann_time_domain), abs(ETFE_Hann_Estimate_gamma_5(idx_Hann_time_domain)));
hold on;
loglog(omega(idx), abs(Gfreq(idx)), 'Color', 'Green');
fig = gcf;
fig.Position = [0, screenheight/4, screenwidth/2, screenheight/2];
